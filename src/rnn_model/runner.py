class MyVMC(VMC):
    ...
    def local_energy(self, samples, params, model, log_psi) -> List[float]:
        ...
        #** TODO_1: Something is missing here **#
        def step_fn_chemical(i, state):
            s, output = state
            output += - `CHANGE_ME` * s[:, i] 
            return s, output
        ...
        # It is a function that takes a flip index and state (1D array of spin configuration), 
        # and returns the flipped_state
        ...
        ## function get_logpsi takes (flipped_state, params, model) as arguments 
        ## and returns the logpsi of the flipped state
        ...
        # Total energy
        #** TODO_4: Something is missing here **#
        loc_e = "" + "" + ""
